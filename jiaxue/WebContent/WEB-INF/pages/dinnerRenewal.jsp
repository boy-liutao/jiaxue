...
<div id="fr_block5">
    <div class="fr_block5_item payment_total">
        <b>支付:</b><b class="sr_total_cash">￥<span id="money"></span></b>
    </div>
...
function countPrice(){
	var hasDinner = true;
	var hasFruit = $("#fr_block3 .renew_unselected").is(":hidden");
...
$("#weixin_pay").click(function(){
	...
	ajaxUtil({uid:<%=user.getId()%>,openId:'<%=user.getOpenid()%>',sid:<%=user.getSid()%>,nurseryUnit:-1,nurseryCount:0,dinnerCount:dinnerCount,fruitCount:fruitCount}, mainpath+"/order/weixinCreate.do", function(response){
		var o = response;
