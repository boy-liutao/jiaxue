...
(function($) {
    ...
    /*
       ...
       *cfg.album  - Array of album urls of album option objects
        cfg.align   - Aling diff-size album
        cfg.cells   - Max grid cells (1-6)
        cfg.getViewAllText     - Returns text for "view all album" link,
        cfg.onGridRendered     - Called when grid items added to the DOM
        cfg.onGridItemRendered - Called when grid item added to the DOM
        cfg.onGridLoaded       - Called when grid album loaded
    ...
    */
    ...
    /*
       ...
       *cfg             - Configuration object
       *cfg.album      - Array of string or objects
